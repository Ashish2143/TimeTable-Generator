                ...
                <div class="row g-5">
                    <div class="col-lg-6 col-md-12 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <%
                                ...
                                try{
                                    ResultSet res = db.getStudentById(Integer.parseInt(studentlogin1));
                                    if(res.next()){
                        ...
                        <form action="includes/WebService.jsp" method="post">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <input type="text" class="form-control border-0 py-3" name="name" value="<%=res.getString("name")%>" required placeholder="Your name">
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <input type="text" class="form-control border-0 py-3" name="enrollno" value="<%=res.getString("enrollno")%>" required placeholder="Your enrollment">
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <input type="date" class="form-control border-0 py-3" name="dob" value="<%=res.getString("dob")%>" required placeholder="Your DOB">
                                    </div>
                                    <div class="col-md-6 mb-4">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <input type="text" class="form-control border-0 py-3" name="semester" value="<%=res.getString("semester")%>" required placeholder="Your Semister">
                                    </div>
                                    <div class="col-md-6 mb-4">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <input type="email" class="form-control border-0 py-3" name="emailid" value="<%=res.getString("emailid")%>" required placeholder="Your emailid">
                                    </div>
                                    <div class="col-md-6 mb-4">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                         <form action="includes/WebService.jsp" method="post">
                                <input type="hidden" name="action" value="updatestudentpwd"/>
                                <center>
                                <%
                                    try {
                                        String status = " ";
