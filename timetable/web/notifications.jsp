    ...
    <body>
        ...
        <div class="container-fluid page-header">
            <div class="container text-center py-2">
                <h1 class="display-2 text-white mb-4 animated slideInDown">Notifications</h1>
            </div>
        </div>
        <!-- Page Header End -->
                    ...
                    <center>
                        <%
                                        try {
                                            ...
                                            if (status.equals("0")) {
                                                out.println("<div class='alert alert-danger' style='font-size: 15px; color:green'>Notification deleted successfully!</div>");
                                            }
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                            <div class="p-5 rounded contact-form">
                                <form action="includes/WebService.jsp" method="post" >
                                    ...
                                    <p style="color:#fff">Add Notifications</p>
                                    <div class="mb-4">
                                        <input type="text" class="form-control border-0 py-3" name="title" required placeholder="Your title">
                                    </div>
                                    <div class="mb-4">
                                        <textarea class="form-control" name="description" required rows="3" placeholder="Your description"></textarea>
                                    </div>
