            ...
            <div class="container py-5">
                <div class="row g-5">
                    <%
                        ...
                        ResultSet res = db.getTimetableById(Integer.parseInt(request.getParameter("tid")));
                        if(res.next()){
...
//                                                System.out.println(sdf.format(calendar.getTime()));
                                    ...
                                    <tr>
                                        ...
                                        <%
                                            ...
                                            while(ress1.next()){
                                                 ...
                                                 prvsub=ress1.getString("subject");
                                                %>
                                        ...
                                        <%
                                            ...
                                            ResultSet ress22 = db.selectAll("select * from subjects where branch = '"+res.getString("branch")+"' and id != "+sub_id1+" and semester = '"+res.getString("semester")+"' and type='Practical' and subject not like '%"+prvsub+"%' order by type asc limit 1 offset 1");
                                            while(ress22.next()){
                                    ...
                                    <tr>
                                        ...
                                        <%
                                            //String[] strArray = new String[5];
                                            int sub_id2 = 0;
                                            ResultSet ress2 = db.selectAll("select * from subjects where branch = '"+res.getString("branch")+"' and semester = '"+res.getString("semester")+"' and type='Practical' and subject not like '%"+prvsub+"%' order by type asc limit 1 offset 1");
                                            while(ress2.next()){
                                                 //strArray[0] = ress.getString("subject");
                                        ...
                                        <%
                                            //String[] strArray = new String[5];
                                            int sub3=0;
                                            ResultSet ress222 = db.selectAll("select * from subjects where branch = '"+res.getString("branch")+"' and id != "+sub_id2+" and semester = '"+res.getString("semester")+"' and type='Practical' and subject not like '%"+prvsub+"%' order by type desc limit 1");
                                            while(ress222.next()){
                                            sub3=ress222.getInt("id");    
                                    ...
                                    <tr>
                                        ...
                                        <%
                                            //String[] strArray = new String[5];
                                            int sub4=0;
                                            ResultSet ress3 = db.selectAll("select * from subjects where branch = '"+res.getString("branch")+"'and id!="+sub_id2+" and id!="+sub3+" and semester = '"+res.getString("semester")+"' and type='Practical' and subject not like '%"+prvsub+"%' order by type asc limit 1 offset 1 ");
                                            while(ress3.next()){
                                            sub4=ress3.getInt("id");
                                            //strArray[0] = ress.getString("subject");
                                                %>
                                        ...
                                        <%
                                            ...
                                            ResultSet ress333 = db.selectAll("select * from subjects where branch = '"+res.getString("branch")+"' and id!="+sub4+" and semester = '"+res.getString("semester")+"' and type='Practical' order by subject asc limit 1 ");
                                            while(ress333.next()){
