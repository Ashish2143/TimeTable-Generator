    ...
    <body>
        ...
        <div class="container-fluid page-header">
            <div class="container text-center py-2">
                <h1 class="display-2 text-white mb-4 animated slideInDown">Timetable</h1>
            </div>
        </div>
        <!-- Page Header End -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        <table class="table table-bordered">
                                                ...
                                                <%
                                                    ...
                                                    if(res.next()){
                                                        int j = 0;
                                                        ResultSet rs = db.getTimetableByBr(res.getString("branch"));
                                                        while (rs.next()) {
                                                %>
                                                <tr>
                                                    ...
                                                    <td>
                                                            <a href="faculty-timetable-generate.jsp?tid=<%=rs.getInt("id")%>" class="btn btn-primary btn-sm" style="width: 100px;">View</a>
                                                    </td>
                                                </tr>
                                                <%
                                                j++;
