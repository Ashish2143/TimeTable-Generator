                    ...
                    <center>
                        <%
                                        try {
                                            ...
                                            if (status.equals("1")) {
                                                out.println("<div class='alert alert-success' style='font-size: 15px; color:green'>Subject added successfully!</div>");
                                            }
                                            
                                            if (status.equals("0")) {
                                                out.println("<div class='alert alert-danger' style='font-size: 15px; color:green'>Subject deleted successfully!</div>");
                                            }
                                    ...
                                    <div class="row p-5 rounded contact-form">
                                        ...
                                        <div class="col-md-12 mb-4">
                                            <table class="table" style="color:#fff">
                                                <tr>
                                                    <th>Branch</th><th>Semester</th><th>Subject</th><th>Type</th><th>Action</th>
                                                </tr>
                                                <%
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                            <div class="p-5 rounded contact-form">
                                <form action="includes/WebService.jsp" method="post" >
                                    ...
                                    <h3 style="color:#fff">Add Subject</h3>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        <input type="text" class="form-control border-0 py-3" name="subject" required placeholder="Enter subject name">
                                    </div>
                                    <div class="mb-4">
                                        <select class="form-control border-0 py-3" name="type" required placeholder="Your type">
