    ...
    <body>
        ...
        <div class="container-fluid page-header">
            <div class="container text-center py-2">
                <h1 class="display-2 text-white mb-4 animated slideInDown">Contacts</h1>
            </div>
        </div>
        <!-- Page Header End -->
                    ...
                    <center>
                        <%
                                        try {
                                            ...
                                            if (status.equals("0")) {
                                                out.println("<div class='alert alert-danger' style='font-size: 15px; color:green'>Contact deleted successfully!</div>");
                                            }
                    ...
                    <div class="row g-5">
                        <div class="col-lg-12 wow fadeIn" data-wow-delay=".5s">
                                    <div class="row p-5 rounded contact-form">
                                        <p style="color:#fff">Contacts</p>
                                        <div class="col-md-12 mb-4">
                                            <table class="table" style="color:#fff">
                                                <tr>
                                                    <th>Name</th><th>Email</th><th>Massage</th><th>Action</th>
                                                </tr>
                                                <%
