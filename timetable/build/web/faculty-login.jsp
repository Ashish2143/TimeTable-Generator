    ...
    <body>
        ...
        <div class="container-fluid page-header">
            <div class="container text-center py-2">
                <h1 class="display-2 text-white mb-4 animated slideInDown">Faculty Login</h1>
            </div>
        </div>
        <!-- Page Header End -->
        ...
        <div class="container-fluid">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                    <h1 class="mb-3">Faculty please login here</h1>
                    <center>
                        <%
                                        try {
                                            String status = " ";
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                            <div class="p-5 rounded contact-form">
                                <form action="includes/WebService.jsp" method="post" >
                                    ...
                                    <p style="color:#fff">Fill below form fields login.</p>
                                    <div class="mb-4">
